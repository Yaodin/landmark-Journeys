...
ROUTES = [
    ...
    },
    {
        ...
        "quality_label": "NTSB secondary-radar track reconstruction",
        "step_km": 0.1,
        ...
        "description": "The route follows the NTSB's secondary-radar position table and flight-track figure. It is not the raw flight-data-recorder dataset.",
        ...
        "anchors": [
            ...
            p("Hudson River turn", 40.8240, -73.9980, "Approximate position digitized from the NTSB track figure."),
            p("Southbound over Hudson", 40.7980, -73.9990, "Approximate position digitized from the NTSB track figure."),
            p("Ditching near West 50th Street", 40.7713278, -74.0056944, "NTSB secondary-radar touchdown position."),
        ],
    },
    {
        "rank": 7,
    ...
    },
    {
        ...
        "anchors": [
            ...
            p("Dual-engine flameout area", 50.46757, -96.05699, "Approximate intersection inferred from inquiry distances"),
            p("Gimli redirect area", 50.62806, -96.77000, "Approximate approach-shaping point"),
